...
DATASET_SPECS_TRACK="${DATASET_SPECS_TRACK:-/data/project-vilab/jaeseok/VideoX-Fun/datasets/dataset_specs_openvid-78k.json}" \
...
CHECKPOINT_DIR_TRACK="/data/project-vilab/jaeseok/VideoX-Fun/checkpoints/wan_track_init-from-scratch-ff-scale-${TRACK_LATENT_FIRST_FRAME_SCALE_TRACK}_rf-scale-${TRACK_LATENT_REST_FRAME_SCALE_TRACK}_openvid-0p6m_wisa-80k" \
