...
FIRST_FRAME_CONDITION_DROP_PROB_TRACK=0.0 \
DEBUG_WEIGHT_UPDATE_TRACK=false \
DEBUG_WEIGHT_UPDATE_TOPK_TRACK=50 \
INIT_MODEL_FROM_CHECKPOINT_TRACK="/data/project-vilab/jaeseok/VideoX-Fun/checkpoints/wan_track_NEW_PARAMS_ONLY_STEPS_10000/checkpoint-3800" \
NEW_PARAMS_ONLY_STEPS_TRACK=0 \
LEARNING_RATE_TRACK=1e-5 \
NEW_TRACK_LAYERS_LR_TRACK=1e-4 \
EARLY_BLOCKS_LR_TRACK=1e-5 \
TRAIN_EARLY_BLOCKS_TRACK=6 \
